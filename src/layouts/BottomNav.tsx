...
export default function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-ka-gray-200 dark:border-gray-700 z-50">
          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {tab.badge && (
                  <Badge className="absolute -top-2 -right-2 bg-ka-green text-white px-1 py-0 text-xs min-w-[18px] h-[18px] flex items-center justify-center">
                    {tab.badge}
                  </Badge>
                )}
              </div>
